...
double view_evaluator_sum::calculateUtiltiy(geometry_msgs::Pose p, Victim_Map_Base *mapping_module){
...
double view_evaluator_sum::calculateWirelessUtility(geometry_msgs::Pose p, Victim_Map_Base *mapping_module)
{
  double IG_view=0;
